...
class PicoScope5000A:
    ...
    def __init__(self, serial=None, resolution_bits=12):
        ...
        self._channels_enabled = {'A': True, 'B': True, 'C': True, 'D': True}
    ...
    def set_trigger_A_OR_B(self, threshold=0., direction='RISING',
        ...
        Direction2       = ps.PS5000A_DIRECTION*4 # see ctypes docs
        trigDirectionAB  = Direction2(ps.PS5000A_DIRECTION(channelA, dir, mode),
                                      ps.PS5000A_DIRECTION(channelB, dir, mode),
                                      ps.PS5000A_DIRECTION(channelC, dir, mode),
                                      ps.PS5000A_DIRECTION(channelD, dir, mode))

        thresholdA = self._rescale_V_to_adc('A', threshold)
        thresholdB = self._rescale_V_to_adc('B', threshold)
        thresholdC = self._rescale_V_to_adc('C', threshold)
        thresholdD = self._rescale_V_to_adc('D', threshold)
        ...
        trigPropertiesAB = \
          Property2(ps.PS5000A_TRIGGER_CHANNEL_PROPERTIES_V2(thresholdA,
                    ...
                    ps.PS5000A_TRIGGER_CHANNEL_PROPERTIES_V2(thresholdB,
                                                             0, 0, 0, channelB),
                    ps.PS5000A_TRIGGER_CHANNEL_PROPERTIES_V2(thresholdC,
                                                             0, 0, 0, channelC),
                    ps.PS5000A_TRIGGER_CHANNEL_PROPERTIES_V2(thresholdD,
                                                             0, 0, 0, channelD))
        ...
        trigConditionC  = ps.PS5000A_CONDITION(channelC, state_true)
        trigConditionD  = ps.PS5000A_CONDITION(channelD, state_true)
